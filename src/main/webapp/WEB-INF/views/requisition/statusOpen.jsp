...
<head>
    <meta charset="UTF-8">
    <title>REQUISITION STATUS-OPEN</title>
...
<div class="header">
    ...
    <div> <h1>REQUISITION STATUS-OPEN</h1></div>
</div>
<ul>
...
<li title="Click to logout"><a class="logout" href="/logout">Logout</a></li>  
 ...
 <table  class="styled1-table" id="myTable">
		...
		<c:forEach var="viewrequisition" items="${viewrequisitions}">
		<c:if test = "${item.status == Status.OPEN}">	
  ...
  <ul class="pagination">
    <li class="page-item"><a class="page-link" href="statusopen?page=0&size=10">1</a></li>
    <li class="page-item"><a class="page-link" href="statusopen?page=1&size=10">2</a></li>
    <li class="page-item"><a class="page-link" href="statusopen?page=2&size=10">3</a></li>
  </ul>
  </nav>
  </c:if>
